...
### 4. Persistence
If a workflow was newly generated by restricted planning and passes validation, it is saved as a reusable workflow template. You can set the default status value to active or inactive via configuring config.json's workflow.autoActivate field.
